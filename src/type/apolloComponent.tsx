...
export type GetPostsQuery = (
  ...
  & { posts?: Maybe<Array<Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'body' | 'tags' | 'thumbnail' | 'created_at' | 'views'>
    & { user?: Maybe<(
      { __typename?: 'User' }
...
export type TopFivePostQuery = (
  ...
  & { topFivePost?: Maybe<Array<Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'title' | 'tags' | 'thumbnail' | 'created_at' | 'views' | 'body'>
    & { user?: Maybe<(
      { __typename?: 'User' }
      & Pick<User, 'id' | 'username'>
    )>, comments?: Maybe<Array<Maybe<(
...
export function useTopFivePostQuery(baseOptions?: Apollo.QueryHookOptions<TopFivePostQuery, TopFivePostQueryVariables>) {
        return Apollo.useQuery<TopFivePostQuery, TopFivePostQueryVariables>(TopFivePostDocument, baseOptions);
      }
export function useTopFivePostLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TopFivePostQuery, TopFivePostQueryVariables>) {
          return Apollo.useLazyQuery<TopFivePostQuery, TopFivePostQueryVariables>(TopFivePostDocument, baseOptions);
        }
...
export function useUploadImageToCloudinaryMutation(baseOptions?: Apollo.MutationHookOptions<UploadImageToCloudinaryMutation, UploadImageToCloudinaryMutationVariables>) {
        return Apollo.useMutation<UploadImageToCloudinaryMutation, UploadImageToCloudinaryMutationVariables>(UploadImageToCloudinaryDocument, baseOptions);
      }
